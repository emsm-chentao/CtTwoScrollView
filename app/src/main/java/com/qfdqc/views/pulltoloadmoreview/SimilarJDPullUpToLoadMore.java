 ...
 */
public class SimilarJDPullUpToLoadMore extends ViewGroup {
    public static String TAG = SimilarJDPullUpToLoadMore.class.getName();

    SimilarJDMyScrollView topScrollView, bottomScrollView;
    ...
    public SimilarJDPullUpToLoadMore(Context context) {
        super(context);
        init();
    }

    public SimilarJDPullUpToLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SimilarJDPullUpToLoadMore(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (SimilarJDMyScrollView) getChildAt(0);
                bottomScrollView = (SimilarJDMyScrollView) getChildAt(2);
                topScrollView.setScrollListener(new SimilarJDMyScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new SimilarJDMyScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
